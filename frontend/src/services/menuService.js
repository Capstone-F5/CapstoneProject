...
function adaptItem(i, locale) {
  ...
  return {
    ...
    name,
    price: Number(i.original_price ?? i.base_price),
    originalPrice: Number(i.original_price ?? i.base_price),
    finalPrice: Number(i.final_price ?? i.base_price),
    discountAmount: Number(i.discount_amount ?? 0),
    appliedDiscounts: i.applied_discounts ?? [],
